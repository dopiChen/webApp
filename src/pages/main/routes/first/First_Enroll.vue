    ...
    <div class="body">
        ...
        <div class="mainbody">
            ...
            <div class="recordbody">
                ...
                <div class="indexbody">
                    <div class ="step1" v-if="recordVisible1" style="height: 1000px;">
                    ...
                    <div class ="step2" v-if="recordVisible2" style="height: 1000px;">
                        <el-steps direction="vertical" :active=activeStep >
                            <el-step title="步骤 1">
                                <template #description>
                                    <div class="info-box">
                    ...
                    <div class ="step3" v-if="recordVisible3" style="height: 1000px;">
                        <el-steps direction="vertical" :active=activeStep >
                            <el-step title="步骤 1">
                                <template #description>
                                    <div class="info-box">
